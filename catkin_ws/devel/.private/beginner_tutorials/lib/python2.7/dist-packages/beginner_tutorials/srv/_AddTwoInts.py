...
class AddTwoIntsResponse(genpy.Message):
  _md5sum = "90c30f4ac96dc42f9594ba161f7b344a"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      pattern = '<%sq'%length
      buff.write(struct.pack(pattern, *self.sum))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.sum = struct.unpack(pattern, str[start:end])
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.sum = numpy.frombuffer(str[start:end], dtype=numpy.int64, count=length)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
...
class AddTwoInts(object):
  ...
  _md5sum = '6cae66e5828d99e5ad73c274058652a1'
